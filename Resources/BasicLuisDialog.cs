...
namespace Microsoft.Bot.Sample.Luis
{
    //For more information about this template visit http://aka.ms/azure-bots-csharp-luis
    [Serializable]
    public class BasicLuisDialog : LuisDialog<object>
    {
        ...
        private async Task After_TitlePrompt(IDialogContext context, IAwaitable<string> result)
        {
            ...
            //Create a new object
            var note = new Note() { Title = title.Entity };
            //Add new note to the list of notes and also save it in order to add text to it later
            noteToCreate = this.noteByTitle[note.Title] = note;
        ...
        public async Task NoteDeleteIntent(IDialogContext context, LuisResult result)
        {
            ...
            {
                //Prompt the user for a note title
                PromptDialog.Text(context, After_DeleteTitlePrompt, "What is the title of he note you want to delete?");
            }
        }
        ...
        [LuisIntent("None")]
        public async Task NoneIntet(IDialogContext context, LuisResult result)
        {
